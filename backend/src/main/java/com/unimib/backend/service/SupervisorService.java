...
import com.unimib.backend.constants.CommonConstants;
import com.unimib.backend.constants.SupervisorConstants;
import com.unimib.backend.enums.WorkerRole;
import com.unimib.backend.repository.SupervisorRepository;
import com.unimib.backend.repository.WorkerRepository;
...
import static com.unimib.backend.POJO.Worker.generateEmail;
import static com.unimib.backend.constants.CommonConstants.*;
import static com.unimib.backend.constants.EmployeeConstants.NOT_A_MANAGER;
import static com.unimib.backend.constants.EmployeeConstants.SALARY_MUST_BE_AT_LEAST_ROLE_MINIMUM;
import static com.unimib.backend.constants.SupervisorConstants.*;
import static com.unimib.backend.constants.TeamConstants.*;
import static com.unimib.backend.constants.WorkerConstants.NULL_WORKER_ID;
import static com.unimib.backend.constants.WorkerConstants.WORKER_NOT_FOUND;
